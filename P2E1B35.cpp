...
/*心得:雖然上次有做過一次作業的經驗了，但那個三角形真的讓我想了很久，
       尤其是該用什麼當變數，以及變數代表什麼，還有for迴圈的使用，同  
	   時要考慮的東西太多了，以至於經常想著想著就忘記剛剛才定義好的 
	   for迴圈在做什麼事。其他部分就沒什麼太大的問題，只是對於題意的 
	   要求不能一次到位，還有行跟列搞錯。這次是我第一次交這麼多commit
	   ，這種感覺很像在交錯誤報告書。 */ 
